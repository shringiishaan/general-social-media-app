...
@Controller("admin/allLocations")
export class AdminAllLocationsController {
	...
	async getMyInterests(@Req() req, @Body() body): Promise<{name: string, latitude: number, longitude: number}[]> {
